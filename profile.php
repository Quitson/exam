      ...
      <div class="row">
        <div class="col s12 m7">
          <div class="card-panel red darken-1">
            <h3 class="white-text center"><?php echo $_SESSION['user']; ?>'s profile page</h3>
          </div>
        </div>
      </div>
          ...
          <div class="col s12 m7">
            <div class="card red darken-1">
              <div class="card-image">
                <img style="width:100%;" src="https://www.bigstockphoto.com/images/homepage/module-6.jpg">
                <span class="card-title"><?php echo $_SESSION['user']; ?></span>
              </div>
